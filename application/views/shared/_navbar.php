...
<nav class="navbar navbar-inverse visible-xs">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li <?php if ($isActive === 'resume'): ?>class="active"<?php endif; ?>><a href="https://www.dropbox.com/s/7er8k54biaspiek/KellyCarter_Resume_100518.pdf?dl=0" target="_blank">Resume</a></li>
